            ...
            <div class="sidebar-contant">
                ...
                <div class="form-group mb-20">
                    ...
                    <ul class="discount">
                        <li>
                            <div class="radio">
                                <input id="disc80" class="radio-button" type="radio" value="disc80"
                                       name="radio-disc">
                        ...
                        <li>
                            <div class="radio">
                                <input id="disc70" class="radio-button" type="radio" value="disc70"
                                       name="radio-disc">
                        ...
                        <li>
                            <div class="radio">
                                <input id="disc60" class="radio-button" type="radio" value="disc60"
                                       name="radio-disc">
                        ...
                        <li>
                            <div class="radio">
                                <input id="disc50" class="radio-button" type="radio" value="disc50"
                                       name="radio-disc">
                        ...
                        <li>
                            <div class="radio">
                                <input id="disc40" class="radio-button" type="radio" value="disc40"
                                       name="radio-disc">
                    ...
                    <ul>
                        <li>
                            ...
                            <span>
                              ...
                              <label for="apple">Apple <span>(15)</span></label>
                            </span>
                            </div>
                        </li>
                        <li>
                            ...
                            <span>
                              ...
                              <label for="prada">Prada <span>(05)</span></label>
                            </span>
                            </div>
                        </li>
                        <li>
                            ...
                            <span>
                              ...
                              <label for="canon">Canon <span>(10)</span></label>
                            </span>
                            </div>
                        </li>
                        <li>
                            ...
                            <span>
                              ...
                              <label for="htc">HTC <span>(10)</span></label>
                            </span>
                            </div>
                        </li>
                        <li>
                            ...
                            <span>
                              ...
                              <label for="palm">Palm <span>(10)</span></label>
                            </span>
                            </div>
                        </li>
                    </ul>
                </div>
                <a href="javascript:void(0)" class="btn btn-color">Refine</a>
            </div>
        </div>
        <div class="sidebar-box mb-40 d-none d-lg-block">
            <a href="javascript:void(0)">
                <img src="images/left-banner.jpg" alt="Roadie">
            </a>
        </div>
    </div>
</div>
