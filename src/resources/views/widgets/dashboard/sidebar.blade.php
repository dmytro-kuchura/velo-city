<div class="default-sidebar">
    <nav class="side-navbar box-scroll sidebar-scroll">
        <ul class="list-unstyled">
            <li>
                <a href="#dropdown-products" aria-expanded="{{ in_array($route, ['dashboard.products.index', 'dashboard.products.edit', 'dashboard.products.create', 'dashboard.brands.index', 'dashboard.brands.create']) ? 'true' : 'false' }}" data-toggle="collapse"><i class="la la-columns"></i><span>Товары</span></a>
