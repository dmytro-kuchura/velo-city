        ...
        <div v-if="!loader">
            <form class="form-horizontal" @submit.prevent="onSubmit">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <textarea class="form-control" rows="5" placeholder="Keywords"
                                  v-model="page.keywords"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="5" placeholder="Description"
                              v-model="page.description"></textarea>
                    </div>
                </div>
                ...
                <button type="submit" class="btn btn-info waves-effect waves-light m-l-10">Обновить</button>
            </form>
        </div>
    ...
    export default {
        ...
        methods: {
            prepareComponent() {
                ...
                axios.get('/api/v1/admin/pages/' + this.post)
            ...
            onSubmit() {
                ...
                axios.post('/api/v1/admin/pages/' + this.post, this.page)
