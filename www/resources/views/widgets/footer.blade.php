                    ...
                    <div class="col-lg-6 ">
                        <div class="footer_social mb-sm-30 center-sm">
                            <ul class="social-icon">
                                ...
                                <li><a title="Instagram" class="rss"><i class="fa fa-instagram"> </i></a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6 ">
                        <div class="payment">
                            <ul class="payment_icon">
                                <li class="visa"><a href="javascript:void(0)"><img src="images/pay1.png"
                                                                                   alt="Roadie"></a></li>
                                ...
                                <li class="vindicia"><a href="javascript:void(0)"><img src="images/pay4.png"
                                                                                       alt="Roadie"></a></li>
                                <li class="atos"><a href="javascript:void(0)"><img src="images/pay5.png"
                                                                                   alt="Roadie"></a></li>
                            </ul>
                        </div>
                    </div>
