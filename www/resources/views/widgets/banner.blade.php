                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-7 col-xl-40per">
                                <div class="banner-detail-inner">
                                    ...
                                    <div class="sub-title">Wide range of best mens / ladies / girls / boys bicycles
                                        from top brands
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6 col-7">
                                <div class="banner-detail-inner">
                                    ...
                                    <div class="sub-title">Experts in Manufacturing and Exporting Bicycle, Mountain
                                        Bike
                                    </div>
                                    <a class="btn btn-color mt-30" href="shop.html">Shop Now!</a>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6 col-7">
                                <div class="banner-detail-inner">
                                    ...
                                    <div class="sub-title"> Latest Bicycle models, prices, current news, Bicycle
                                        comparisons
                                    </div>
                                    <a class="btn btn-color mt-30" href="shop.html">Shop Now!</a>
                                </div>
