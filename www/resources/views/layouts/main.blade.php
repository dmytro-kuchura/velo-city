...
<div class="main">
                                    ...
                                    <div class="col-12">
                                        <div class="product-detail-main">
                                            <div class="product-item-details">
                                                ...
                                                <div class="price-box"> <span class="price">$520.00</span> <del class="price old-price">$620.00</del> </div>
                                                ...
                                                <div class="mb-20">
                                                    <div class="bottom-detail cart-button">
                                                        <ul>
                                                            ...
                                                            <li class="pro-compare-icon"><a href="compare.html"><span><i class="fa fa-signal"></i></span>Compare</a></li>
                                                            <li class="pro-email-icon"><a href="javascript:void(0)"><span><i class="fa fa-envelope"></i></span>Email to Friends</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="col-6">
                        <div class="top-left">
                            <ul>
                                ...
                                <li>
                                    <div class="info">
                                        Don’t miss it: Save up to $200!
                                        <span class="coupon"> <i class="fa fa-gift"></i> Code : ROAD50</span>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="top-right-link right-side">
                            <ul>
                                <li class="info-link login-icon content">
                                    <a href="login.html" title="Login"><img src="images/top-icon1.png" alt="Roadie">Login</a>
                                </li>
                                <li class="info-link register-icon">
                                    <a href="register.html" title="Register"><img src="images/top-icon2.png" alt="Roadie">Register</a>
                                </li>
                                <li class="info-link contact-icon">
                                    <a href="contact.html" title="Contact Us"><img src="images/top-icon3.png" alt="Roadie">Contact Us</a>
                                </li>
                                <li class="info-link checkout-icon">
                                    <a href="checkout.html" title="Checkout"><img src="images/top-icon4.png" alt="Roadie">Checkout</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-5 col-lg-5 menu-position col-xl-40per p-0  position-initial">
                        <div id="menu" class="navbar-collapse collapse" >
                            <ul class="nav navbar-nav">
                                                                    ...
                                                                    <div class="owl-carousel sub_menu_slider">
                                                                        <div class="product-item">
                                                                            ...
                                                                            <div class="product-item-details">
                                                                                ...
                                                                                <div class="price-box"> <span class="price">$520.00</span>
                                                                                </div>
                                ...
                                <li class="level dropdown"> <span class="opener plus"></span> <a href="shop.html" class="page-scroll">Kids<div class="menu-label"><span class="new-menu"> New </span></div></a>
                                    <div class="megamenu mobile-sub-menu">
                                        <div class="megamenu-inner-top">
                                            <ul class="sub-menu-level1">
                                ...
                                <li class="level dropdown"> <span class="opener plus"></span> <a href="javascript:void(0)" class="page-scroll">Pages</a>
                                    <div class="megamenu mobile-sub-menu">
                                        <div class="megamenu-inner-top">
                                            <ul class="sub-menu-level1">
                                                <li class="level2">
                                                    <ul class="sub-menu-level2 ">
                                                        ...
                                                        <li class="level3"><a href="about-2.html"><span>■</span>About Us 2</a></li>
                                                        <li class="level3"><a href="about-3.html"><span>■</span>About Us 3</a></li>
                                ...
                                <li class="cart-icon">
                                    ...
                                    <div class="cart-dropdown header-link-dropdown">
                                        ...
                                        <div class="mt-20">
                                            ...
                                            <a href="checkout.html" class="btn-color btn right-side"><i class="fa fa-share"></i>Checkout</a>
                                        </div>
                                    </div>
                                </li>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-7 col-xl-40per">
                                    <div class="banner-detail-inner">
                                        <span class="slogan">Best Collection</span>
                                        <h1 class="banner-title">Roadie Gear Bicycles</h1>
                                        <div class="sub-title">Wide range of best mens / ladies / girls / boys bicycles from top brands</div>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6 col-7">
                                    <div class="banner-detail-inner">
                                        <span class="slogan">Best Price</span>
                                        <h1 class="banner-title">Roadie Sports Bicycle</h1>
                                        <div class="sub-title">Experts in Manufacturing and Exporting Bicycle, Mountain Bike</div>
                                        <a class="btn btn-color mt-30" href="shop.html">Shop Now!</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6 col-7">
                                    <div class="banner-detail-inner">
                                        ...
                                        <h1 class="banner-title">Roadie Race Bicycle</h1>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="heading-part align-center mb-30">
                            <h2 class="main_title heading"><span>Featured Products</span></h2>
                        </div>
                    </div>
                </div>
                <div class="pro_cat">
    ...
    <section class="client-bg ptb-70">
        <div class="top-shadow">
            <img alt="Roadie" src="images/top-shadow.png">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                            ...
                            <div id="client" class="owl-carousel">
                                <div class="item client-detail">
                                    ...
                                    <div class="client-img">
                                        ...
                                        <img alt="Roadie" src="images/testimonial_img1.jpg">
                                    </div>
                                </div>
                                <div class="item client-detail">
                                    <div class="quote">
                                    ...
                                    <div class="client-img ">
                                        <div class="designation">Maneger of Business  Development</div>
                                        <img alt="Roadie" src="images/testimonial_img2.jpg">
                                    </div>
                                </div>
                                <div class="item client-detail">
                                    <div class="quote">
                                    ...
                                    <div class="client-img ">
                                        <div class="designation">Maneger of Business  Development</div>
                                        <img alt="Roadie" src="images/testimonial_img3.jpg">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="blog-detail">
                                        ...
                                        <div class="post-info">
                                            <p>Lorem ipsum dolor sit amet, consec adipiscing elit. Donec eros tellus, nec consec elit. Donec eros tellus laoreet sit amet. Lorem ipsum dolor sit amet, consec adipiscing elit.</p>
                                            <ul>
                                                <li>
