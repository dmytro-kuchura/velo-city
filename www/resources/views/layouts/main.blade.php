                                                    ...
                                                    <div class="bottom-detail cart-button">
                                                        <ul>
                                                            ...
                                                            <li class="pro-wishlist-icon"><a href="wishlist.html"><span><i
                                                                                class="fa fa-heart"></i></span>Wishlist</a>
                                                            </li>
                                                            <li class="pro-compare-icon"><a href="compare.html"><span><i
                                                                                class="fa fa-signal"></i></span>Compare</a>
                                                            </li>
                                                            <li class="pro-email-icon"><a
                                                                        href="javascript:void(0)"><span><i
                                                                                class="fa fa-envelope"></i></span>Email
                                                                    to Friends</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
